$(document).ready(function(){
 ...
 $('#aa').DataTable( {
    ...
    $(".link_bcPopupSearch1").click(function(){
        if($("#bcPopupSearch1").is(":visible")){
            $("#bcPopupSearch1").fadeOut(200);
        }else{
            $("#bcPopupSearch1").fadeIn(300);
             $("#bcPopupSearch").fadeOut(200);
              $("#bcPopupSearch2").fadeOut(200);
        }
        return false;
    });  
     ...
     $(".link_bcPopupSearch2").click(function(){
        if($("#bcPopupSearch2").is(":visible")){
            $("#bcPopupSearch2").fadeOut(200);
        }else{
            $("#bcPopupSearch2").fadeIn(300);
             $("#bcPopupSearch1").fadeOut(200);
              $("#bcPopupSearch").fadeOut(200);
        }
        return false;

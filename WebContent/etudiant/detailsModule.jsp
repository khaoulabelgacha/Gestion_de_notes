...
<body onload="renderTime();" >
  ...
  <br><br> <br><br>
            <div class="row-fluid">
                ...
                <div class="span12">                    
                    <div class="head clearfix" style=" margin-top: -10px;" >
                        <div class="isw-grid"></div>
                          <h3> Liste des Notes : ${modulee.libele}      </h3>
	...
	<th>Note</th>
                            ...
                            <tbody>
<c:forEach items="${examesNotes }" var="examNote">
	<tr>
			<td>	${examNote.key.dateExam } </td>
	
 			<td>  ${examNote.value }</td>
